        ...
        <div>
          ...
          <nav className="space-y-1 p-4">
            ...
            <div className="space-y-1 pt-2">
              ...
              {homeOpen && (
                <div className="ml-6 mt-1 space-y-1 border-l border-slate-800 pl-9">
                  ...
                  <button onClick={() => router.push("/admin/bottom-banner")} className={`block w-full py-1.5 text-left text-xs transition-all ${isActive("/admin/bottom-banner") ? "font-bold text-amber-400" : "text-slate-400 hover:text-amber-400"}`}>Bottom Wide Banner</button>
                </div>
              )}
            </div>
            ...
            <div className="space-y-1 pt-4">
              ...
              >
                <ShoppingBag className="h-4 w-4" /> Products Grid
              </button>
